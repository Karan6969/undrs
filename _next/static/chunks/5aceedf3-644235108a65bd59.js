"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[7802],{14282:function(e,t,i){i.d(t,{C:function(){return tr},X:function(){return eY},a5:function(){return te},aa:function(){return tt},ab:function(){return ti},c:function(){return tL},o:function(){return iu}});var r,n=i(95723),s=i(38954),a=i(9858),o=i(69703),l=i(95893);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let u=new s.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function d(e,...t){h.logLevel<=a.in.ERROR&&h.error(`Auth (${n.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e8(e,t,i=!1){if((0,n.rh)(e.app))return Promise.reject(g(e));let r="signIn",s=await e9(e,r,t),a=await e1._fromIdTokenResponse(e,r,s);return i||await e._updateCurrentUser(a.user),a}async function e6(e,t){return e8(ey(e),t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
